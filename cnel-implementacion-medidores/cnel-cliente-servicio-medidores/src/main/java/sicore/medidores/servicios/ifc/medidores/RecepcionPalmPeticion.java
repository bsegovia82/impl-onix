...
/**
 * <p>Clase Java para recepcionPalmPeticion complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="recepcionPalmPeticion">
 *   &lt;complexContent>
...
@XmlType(name = "recepcionPalmPeticion", propOrder = {
    "recepcionPalm"
})
public class RecepcionPalmPeticion
    extends Peticion
{
